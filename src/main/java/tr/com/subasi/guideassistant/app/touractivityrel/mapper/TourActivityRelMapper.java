package tr.com.subasi.guideassistant.app.touractivityrel.mapper;
...
public interface TourActivityRelMapper extends BaseMapper<TourActivityRelModel, TourActivityRelEntity> {
